...
class Data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.cfg.mode == 'train':
            ...
            body1 = cv2.imread(self.cfg.datapath+'/body1-origin/'+name+'.png', 0).astype(np.float32)
            detail1 = cv2.imread(self.cfg.datapath+'/detail1-origin/'+name+'.png', 0).astype(np.float32)
            body2 = cv2.imread(self.cfg.datapath+'/body2-origin/'+name+'.png', 0).astype(np.float32)
            detail2 = cv2.imread(self.cfg.datapath+'/detail2-origin/'+name+'.png', 0).astype(np.float32)
